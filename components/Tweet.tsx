    ...
    <div className="flex flex-col space-x-3 border-y p-5 border-gray-100">
      ...
      {commentBoxVisible && (
        <form onSubmit={handleSubmit} className="mt-3 flex space-x-3">
          <input value={input} onChange={e=>session && setInput(e.target.value)} className="flex-1 rounded-lg bg-gray-100 p-2 outline-none" placeholder="Write a comment" type="text" />
